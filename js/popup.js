...
let reDefault = document.getElementById('reDefault');
    ...
    backColor.onchange=chengeParams;
    textColor.onchange=chengeParams;
    linkColor.onchange=chengeParams;
    linkHover.onchange=chengeParams;
    visited.onchange=chengeParams;
    imgOpacity.onchange=chengeParams;
